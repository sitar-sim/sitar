...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/3_io_procedures.sitar:get_token"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/3_io_procedures.sitar:send_token"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/3_io_procedures.sitar:merger"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/3_io_procedures.sitar:harness"
```
