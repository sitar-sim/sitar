...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_state_machine.sitar:top"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_state_machine.sitar:main_fsm"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_state_machine.sitar:side_fsm"
```
