...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_shift_register.sitar:structure"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_shift_register.sitar:producer"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_shift_register.sitar:stage"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_shift_register.sitar:consumer"
```
