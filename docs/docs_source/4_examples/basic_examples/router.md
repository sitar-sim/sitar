...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_router.sitar:top"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_router.sitar:router"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_router.sitar:source"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/4_router.sitar:sink"
```
