...
``` cpp linenums="1"
--8<-- "docs_source/sitar_examples/pipelined_processor/PipelineTypes.h"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/pipelined_processor/PipelinedProcessor.sitar:top"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/pipelined_processor/PipelinedProcessor.sitar:pipelined_processor"
```
...
``` sitar linenums="1"
--8<-- "docs_source/sitar_examples/pipelined_processor/PipelinedProcessor.sitar:stage"
```
